  ...
  cards: [
    {
      ...
      keys: 'instant vector',
      badge: 'basic',
      description: 'A set of time series, each with a single sample at the evaluation timestamp. The most common return type.',
...
# → all samples in the last 5 minutes`,
    },
    {
      ...
      keys: 'scalar number',
      badge: 'basic',
      description: 'A single floating-point number. Returned by literals and the <code>scalar()</code> function.',
      code: `3.14
scalar(sum(up))`,
    },
    {
