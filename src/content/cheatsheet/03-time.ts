  ...
  cards: [
    {
      ...
      keys: 'duration units',
      badge: 'basic',
      description: 'Combine integer + unit. Units can be chained, biggest first, no spaces.',
      code: `5m      # 5 minutes
1h30m   # 1.5 hours
7d      # 7 days
1y2w    # 1 year 2 weeks
# units: ms s m h d w y`,
    },
    {
      ...
      badge: 'basic',
      description: 'Square brackets after a selector capture all samples in that window.',
    ...
    },
    {
      ...
      keys: 'subquery',
      badge: 'advanced',
      description: '<code>[range:resolution]</code> — evaluates an instant-vector expression over a range, like a recording rule on the fly. Resolution is optional.',
      code: `max_over_time(
