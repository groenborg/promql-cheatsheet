...
export const section: Section = {
  ...
  cards: [
    ...
    },
    {
      ...
      badge: 'basic',
      description: 'Exact string match. Most common matcher in everyday queries.',
    ...
    },
    {
      ...
      badge: 'basic',
      description: 'Exclude a label value. Useful for filtering out a noisy instance or status.',
    ...
    },
    {
      ...
      keys: 'regex match',
      badge: 'basic',
      description: 'RE2 regex, fully anchored automatically. Great for OR-ing several values.',
...
up{job=~"api|web|worker"}`,
    ...
    },
    {
      ...
      badge: 'advanced',
      description: 'An empty string matches series where the label is unset. Pair with <code>=</code> or <code>!=</code>.',
...
up{env!=""}`,
    },
    {
      ...
      badge: 'advanced',
      description: 'The metric name lives in the special <code>__name__</code> label, so you can regex-match it too.',
    ...
    },
    {
      ...
      badge: 'advanced',
      description: 'Shifts the evaluation time backward. <code>@</code> pins it to a Unix timestamp.',
